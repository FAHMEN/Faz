...
async function writeExif(media, data) {
    ...
    if (data) {
        ...
        const wr = { a: global.author ? global.author : 'Fahril', b: data.packname ? data.packname : global.packname ? global.packname : 'Fazbot WhatsApp', c: data.author ? data.author : global.author ? global.author : 'Fahril', d: data.categories ? data.categories : [""], e: data.isAvatar ? data.isAvatar : 0 }
